...
function _pretzel_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( '_pretzel_custom_background_args', array(
...
function _pretzel_scripts() {
	...
	wp_enqueue_script( '_pretzel-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( '_pretzel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
